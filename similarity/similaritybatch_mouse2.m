function similaritybatch_mouse2(type)
format compact
format short g
...
name=input('Name/number/age of mouse: ','s')
datadir=cd;
...
cd(savedir);
savenameSB=strcat('SimilarityBatch_',name);
...
save(savenameSB,'SimilarityBatch','fns1','fns2','SeqMatch','dC_sim');
